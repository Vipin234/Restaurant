...
public function sub_order_create_slip_supervisor_for_chef_post()
   ...
   }else
   {
    ...
    public function completeOrderByWaiter_post()
    {
      ...
      $result=$this->Supervisor->completAllSubOrder($order_id,$admin_id,'Rejected',$waiter_mobile_no);
            if(empty($result2))
            {
            ...
            foreach($result as $value)
                {
                  ...
                  $arry['menu_item_name']=$value['menu_item_name'];
                  $arry['quantity']=$value['quantity'];
                  $arry['half_and_full_status']=$value['half_and_full_status'];
                  $arry['menu_price']=$value['menu_price'];
                    ...
                    foreach($result2 as $value2)
                      {
                                ...
                                $arry2['menu_item_name']=$value2['menu_item_name'];
                                $arry2['quantity']=$value2['quantity'];
                                $arry2['half_and_full_status']=$value2['half_and_full_status'];
                                $arry2['menu_price']=$value2['menu_price'];
