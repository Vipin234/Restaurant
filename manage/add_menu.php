        ...
        <div class="right_col" role="main">
             ...
             <form method="post" action="" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                     ...
                     <!--  <div class="item form-group">
                      ...
                      <div id="fixed-price">
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align"><b>Price</b>                        </label>
                        <div class="col-md-6 col-sm-6 ">
                       ...
                       <div id="price">
                       <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align"><b>Half Price</b> </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input id="email" class="form-control" name="half-price" type="number">
                        </div>
                      </div>
                       <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align"><b>Full Price </b>                        </label>
                        <div class="col-md-6 col-sm-6 ">
