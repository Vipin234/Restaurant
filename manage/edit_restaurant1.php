...
$long = $json->{'results'}[0]->{'geometry'}->{'location'}->{'lng'};
  ...
  move_uploaded_file($tmpimage,"../Restaurant_images/$image");
  $updated_date      = date('Y-m-d H:i:s');
  $qry = "UPDATE spots SET city = '$city_name',name = '$name',image = '$image1',lat = '$lat',lng = '$long',location = '$address',openingTime = '$opening_time',closingTime = '$closing_time',phone = '$phone',address = '$adress',amenities = '$amenities',`gst_no` = '$gst_no',modified_date = '$updated_date' WHERE spotId = '$restaurant_id'";
  //echo $qry;exit;
