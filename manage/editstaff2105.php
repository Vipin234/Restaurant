...
/*	$lastname  = $_POST['lastname'];*/
  ...
  $Paddress  = $_POST['Paddress'];
	...
	$qry = "UPDATE `tbl_restaurant_staff_registration` SET `admin_id` = '$adminid',`name`= '$fullname',`username`='$username',`email`= '$email',`password`= '$password',`aadhar_no` = '$aadhar_no',`pan_number` = '$pan_no',`gender` = '$gender',`mobile_no`= '$mobile',`current_address` = '$Caddress',`permanent_address` = '$Paddress',`modified_date`='$date',`user_type`='$stafftype' WHERE `id` = $staff_id";
	//echo $qry;exit;
  ...
  <body class="nav-md">
    <div class="container body">
                    ...
                    // echo $query;exit;
                     ...
                     $data   = mysqli_fetch_array($runqry);?>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input id="middle-name" class="form-control" value="<?php echo $data['username'];?>" name="username" type="text" required="required">
                        </div>
                      </div>
                       <div class="item form-group">
                     ...
                     <!--  <div class="item form-group">
                      ...
                      <div class="item form-group">
                        <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align"><b>Gender </b></label>
                      <div class="form-check-inline col-md-2" id="fixed">
                       <label class="form-check-label">
                         <input type="radio" class="form-check-input" name="gender" value="male" <?php if($data['gender'] == 'male'){ echo "checked";}?>>Male
                       </label>
                     </div>
                     <div class="form-check-inline col-md-3" id="half_full">
                       <label class="form-check-label">
                         <input type="radio" class="form-check-input" name="gender" value="female" <?php if($data['gender'] == 'female'){ echo "checked";}?>>Female
                       </label>
                     </div>
                     </div> 
      ...
      <select class="form-control" id="sel1" name="staff" required="required">
        ...
        <option name="staff" value="Cashier" <?php if($data['user_type'] == 'Cashier') { ?> selected="selected"<?php } ?>>Cashier</option>
