...
//	echo "pankaj";
  ...
  $stafftype = $_POST['staff'];
	...
	$qry = "INSERT INTO `tbl_restaurant_staff_registration`(`admin_id`,`name`,`username`, `mobile_no`, `email`, `password`,`aadhar_no`,`pan_number`,`gender`, `current_address`, `permanent_address`, `user_type`,`create_date`,`status`) VALUES ('$adminid','$fullname','$username','$mobile','$email','$password','$aadhar_no','$pan_no','$gender','$caddress','$paddress','$stafftype','$date',1)";
	//echo $qry;exit;
