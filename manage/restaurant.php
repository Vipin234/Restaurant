...
else
{
  $display = '';
              ...
              <div class="pull-right" style="display: <?php echo $display;?>">
              <input class="btn btn-primary" type="button" name="add_restaurant" value="Add Restaurant"
                onclick="window.location.href='<?php echo "add_restaurant.php"; ?>';"/>
            </div>
                 <?php $qry = "SELECT * FROM spots WHERE admin_id = '$adminid'";
                 //echo $qry;exit;
             ...
             <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo $fetchdata['gst_no'];?></td>
                          <td><?php echo $fetchdata['location'];?></td>
                          <td><?php echo $fetchdata['openingTime'];?></td>
                          <td><?php echo $fetchdata['closingTime'];?></td>
                          <td><?php echo $fetchdata['phone'];?></td>
                          <td><?php echo $fetchdata['address'];?></td>
                          <td><img src="<?php echo 'http://'.$_SERVER['SERVER_NAME'].'/Restaurant/uploads'.'/'.$fetchdata['image']; ?>" height="80px" width="120px"/></td>
                          <!-- <td><?php //echo $fetchdata['create_date'];?></td> -->
                           <td><a href="edit_restaurant.php?restaurant_id=<?php echo $fetchdata['spotId']?>"><i class="fa fa-pencil" aria-hidden="true"></i></a> </td>
