...
{    
    ...
    function getGroupData($admin_id,$order_status)
    {
      ...
      {
        //echo "SELECT * from tbl_order_detail_for_restaurant where admin_id='$admin_id' and order_status='Pending' group by order_id ORDER BY create_date DESC";exit;
        $data=$this->db->query("SELECT * from tbl_order_detail_for_restaurant where admin_id='$admin_id' and order_status='Pending' group by order_id ORDER BY create_date DESC");
     	return($data->result_array());
      }
      elseif($order_status=='Confirm')
      {
        //echo "SELECT * from tbl_order_detail_for_restaurant where admin_id='$admin_id' and (order_status='confirm' OR order_status='Prepare') and order_status !='Ready to Serve' group by order_id ORDER BY create_date DESC";exit;
        $data=$this->db->query("SELECT * from tbl_order_detail_for_restaurant where admin_id='$admin_id' and (order_status='confirm' OR order_status='Prepare') and order_status !='Ready to Serve' group by order_id ORDER BY create_date DESC");
        return($data->result_array());
      }
   elseif($order_status=='Waiting')
      {
        //echo "SELECT * from tbl_order_detail_for_restaurant where admin_id='$admin_id' and order_status='confirm' and order_status !='Ready to Serve' group by order_id ORDER BY create_date DESC";exit;
        $data=$this->db->query("SELECT * from tbl_order_detail_for_restaurant where admin_id='$admin_id' and order_status='confirm' and order_status !='Ready to Serve'and slip_status=0 group by order_id ORDER BY create_date DESC");
        return($data->result_array());
      }

     elseif($order_status=='ready to serve')
      {
           //echo "SELECT * from tbl_order_detail_for_restaurant where admin_id='$admin_id' and order_status='Ready to Serve' group by order_id ORDER BY create_date DESC";exit;
          $data=$this->db->query("SELECT * from tbl_order_detail_for_restaurant where admin_id='$admin_id' and order_status='Ready to Serve' group by order_id ORDER BY create_date DESC");
          return($data->result_array());
      }       
      elseif($order_status=='Prepare')
      {
          $data=$this->db->query("SELECT * from tbl_order_detail_for_restaurant where admin_id='$admin_id' and order_status='Prepare' group by order_id ORDER BY create_date DESC");
          return($data->result_array());
      }  
    }
