...
<?php
	...
	{
		$string1="Update tbl_order_detail_for_restaurant set order_status='Closed',status='7' WHERE order_id='$order_id' and status !=0";
		$string2="Update tbl_sub_order_detail_for_restaurant set order_status='Closed',status='7'WHERE order_id='$order_id' status !=0";
